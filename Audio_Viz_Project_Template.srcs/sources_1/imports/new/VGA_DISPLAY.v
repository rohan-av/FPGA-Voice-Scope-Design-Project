...
module VGA_DISPLAY(
    ...
    wire[3:0] VGA_RED_CHAN = (advanced_sw == 1) ? ( VGA_RED_GRID | VGA_RED_VOL |  VGA_RED_BOX | VGA_CBOXR | VGA_MENUR | VGA_RED_WAVEFORM | VGA_RED_JOY_WAVEFORM | TEXTR) : (VGA_RED_GRID | VGA_RED_WAVEFORM | TEXTR) ;
    wire[3:0] VGA_GREEN_CHAN = (advanced_sw == 1) ? (VGA_GREEN_GRID | VGA_GREEN_VOL |  VGA_GREEN_BOX | VGA_CBOXG | VGA_MENUG | VGA_GREEN_WAVEFORM | VGA_GREEN_JOY_WAVEFORM | TEXTG) : (VGA_GREEN_GRID | VGA_GREEN_WAVEFORM | TEXTG) ; 
    wire[3:0] VGA_BLUE_CHAN = (advanced_sw == 1) ? (VGA_BLUE_GRID | VGA_BLUE_VOL |  VGA_BLUE_BOX | VGA_CBOXB | VGA_MENUB | VGA_BLUE_WAVEFORM | VGA_BLUE_JOY_WAVEFORM | TEXTB) : (VGA_BLUE_GRID | VGA_BLUE_WAVEFORM | TEXTB); 
