...
module VGA_DISPLAY(
    ...
    //wire [3:0] bg_muxR = (VGA_RED_VOL)? VGA_RED_VOL : VGA_RED_GRID; // VGA_RED_GRID | VGA_RED_VOL
    //wire [3:0] bg_muxG = (VGA_GREEN_VOL)? VGA_GREEN_VOL : VGA_GREEN_GRID;
    //wire [3:0] bg_muxB = (VGA_BLUE_VOL)? VGA_BLUE_VOL : VGA_BLUE_GRID;
